...
<form name="form1" method="post" action="searchveri.php">
    ...
    <table width="93%" height="77" border="0">
      <tr> 
        ...
        <td width="222"><select name="sersel" id="search1" class="txtbox" title="Select Search Cretaria" onMouseOver="this.style.borderColor='#ff0000'" onmouseout="this.style.borderColor='blue'">
            ...
            <option <?php if ($_POST['sersel'] == 'name') { ?>selected="true" <?php }; ?>value="name">By Name</option>
      ...
      <tr> 
        <td height="28">&nbsp;</td>
        <td><input type="Submit" name="submit" value="SUBMIT" class="printbutton" title="Click here to Submit" onMouseOver="this.style.borderColor='#FFFF00'" onMouseOut="this.style.borderColor='blue'"></td>
        <td>&nbsp;</td>
      </tr>
    </table>
</div>
